...
@interface DetailsHeadView ()<SDCycleScrollViewDelegate>
// 商品图片
...
//    
//    if (imageArray.count <= 1 || imageArray.count == 0)
//    {
...
//        
//        goodsImage.image = [UIImage imageNamed:@"placeholderImage"];
//    
...
//{
//    [[NSNotificationCenter defaultCenter] postNotificationName:@"share" object:self userInfo:nil];
//}
