...
@interface MakeEstimateViewController ()

@end

@implementation MakeEstimateViewController
...
- (void)addView
{
    ...
    [confirmBtn setTitle:@"待评价" forState:UIControlStateNormal];
