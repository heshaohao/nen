...
@implementation MYForTheViewCell
...
- (void)payBtnClick
{
    ...
    //NSLog(@"%@----%@",self.model.Id,self.model.state);
    
    NSDictionary *dict = @{@"orderId":self.model.Id,@"state":self.model.state};
    
    
    [[NSNotificationCenter defaultCenter] postNotificationName:@"forTheRightBtn" object:self userInfo:dict];
}
...
- (void)logisticsBtnClick
{
    ...
    NSDictionary *dict = @{@"orderId":self.model.Id,@"state":self.model.state,@"goodsImage":self.otherModel.goods_img};
    
//    [[NSNotificationCenter defaultCenter] postNotificationName:@"forTheLeftBtn" object:self];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"forTheLeftBtn" object:self userInfo:dict];
