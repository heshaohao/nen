...
@implementation MYSendTheViewCell
...
- (void)payBtnClick
{
    ...
    NSDictionary *dict = @{@"goodsId":self.otherModel.id,@"orderId":self.model.Id,@"state":self.model.state,@"orderId":self.model.Id};
    
    [[NSNotificationCenter defaultCenter] postNotificationName:@"SendTheRightBtn" object:self userInfo:dict];
}
...
- (void)logisticsBtnClick
{
    ...
    NSDictionary *dict = @{@"state":self.model.state,@"orderId":self.model.Id,@"goodsImage":self.otherModel.goods_img};
    
    [[NSNotificationCenter defaultCenter] postNotificationName:@"SendTheLeftBtn" object:self userInfo:dict];
