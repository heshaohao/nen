...
#import "MYRefundAndRepairViewController.h"
#import "SHTitleButton.h"
#import "MyShoppView.h"


@interface MYShoppingListViewController ()<UIScrollViewDelegate>
/** 当前选中的标题按钮 */
...
{
    MYAllOrderViewController *all = [[MYAllOrderViewController alloc] init];
    [self addChildViewController:all];
    
    MYObligationsViewController *obligationsVc = [[MYObligationsViewController alloc] init];
    [self addChildViewController:obligationsVc];
    
    MYSendTheVGoodsiewController *sendVc = [[MYSendTheVGoodsiewController alloc] init];
    [self addChildViewController:sendVc];
    
    MYForTheGoodsViewController *fotTheVc = [[MYForTheGoodsViewController alloc] init];
    [self addChildViewController:fotTheVc];
    
    MYToEvaluateViewController *toEvaluateVc = [[MYToEvaluateViewController alloc] init];
    [self addChildViewController:toEvaluateVc];
    
    MYRefundAndRepairViewController *RefundVc = [[MYRefundAndRepairViewController alloc] init];
...
- (void)setupTitlesView
{
    ...
    // 添加标题
    NSArray *titles = @[@"全部",@"待付款",@"待发货",@"待收货",@"待评价",@"退款/返修"];
