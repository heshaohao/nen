...
#import "DreivingAllsViewController.h"
#import "DrivingPaymentsViewController.h"
#import "DrivingDeterminesViewController.h"
#import "DrivingStudysViewController.h"
#import "DrivingEvaluatesViewController.h"
#import "SHTitleButton.h"

@interface DrivingOrderasViewController ()<UIScrollViewDelegate>
/** 当前选中的标题按钮 */
...
@implementation DrivingOrderasViewController
...
{
    DreivingAllsViewController *all = [[DreivingAllsViewController alloc] init];
    [self addChildViewController:all];
    
    DrivingPaymentsViewController *paymentVc = [[DrivingPaymentsViewController alloc] init];
    [self addChildViewController:paymentVc];
    
    DrivingDeterminesViewController *determineVc = [[DrivingDeterminesViewController alloc] init];
    [self addChildViewController:determineVc];
    
    DrivingStudysViewController *studyVc = [[DrivingStudysViewController alloc] init];
    [self addChildViewController:studyVc];
    
    DrivingEvaluatesViewController *EvaluateVc = [[DrivingEvaluatesViewController alloc] init];
...
- (void)setupTitlesView
{
    ...
    // 添加标题
    NSArray *titles = @[@"全部",@"待付款",@"待确认",@"待学习",@"待评价"];
