...
#import "PoiontMenuAllViewController.h"
#import "MakePointViewController.h"
#import "PointConfirmViewController.h"
#import "PointPaymentViewController.h"
#import "PointDiningViewController.h"
#import "PointEvaluateViewController.h"
#import "SHTitleButton.h"

@interface PointMenusViewController ()<UIScrollViewDelegate>
...
@implementation PointMenusViewController
...
{
    PoiontMenuAllViewController *all = [[PoiontMenuAllViewController alloc] init];
    [self addChildViewController:all];
    
    MakePointViewController *makeVc = [[MakePointViewController alloc] init];
    [self addChildViewController:makeVc];
    
    PointConfirmViewController *confirmVc = [[PointConfirmViewController alloc] init];
    [self addChildViewController:confirmVc];
    
    PointPaymentViewController *paymentVc = [[PointPaymentViewController alloc] init];
    [self addChildViewController:paymentVc];
    
    PointDiningViewController *diningVc = [[PointDiningViewController alloc] init];
    [self addChildViewController:diningVc];

    PointEvaluateViewController *evaluateVc = [[PointEvaluateViewController alloc] init];
...
- (void)setupTitlesView
{
    ...
    // 添加标题
    NSArray *titles = @[@"全部",@"预约",@"待确定",@"待付款",@"待就餐",@"待评价"];
