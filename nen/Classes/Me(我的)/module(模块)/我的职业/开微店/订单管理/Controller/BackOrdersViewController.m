...
@interface BackOrdersViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BackOrdersViewController
...
- (void)loadNewData
{
    ...
    [MerchantsOrdersModel merchantsOrdersModelState:@"3" PageSize:@"8" Page:self.page success:^(NSMutableArray<MerchantsOrdersModel *> *merchantsOrdersArray) {
...
- (void)loadMoreData
{
    ...
    NSDictionary *dict = @{@"page":self.page,@"pagesize":@"8",@"state":@"3"};
