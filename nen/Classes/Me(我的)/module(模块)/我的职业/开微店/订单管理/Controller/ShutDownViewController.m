...
@interface ShutDownViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)loadNewData
{
    ...
    [MerchantsOrdersModel merchantsOrdersModelState:@"5" PageSize:@"8" Page:self.page success:^(NSMutableArray<MerchantsOrdersModel *> *merchantsOrdersArray) {
...
- (void)loadMoreData
{
    ...
    NSDictionary *dict = @{@"page":self.page,@"pagesize":@"8",@"state":@"5"};
