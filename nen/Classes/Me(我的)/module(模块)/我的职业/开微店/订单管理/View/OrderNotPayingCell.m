...
@implementation OrderNotPayingCell
...
-(void)addSubviewControll
{
    ...
    UIView *bottomViewTwo = [[UIView alloc] init];
    bottomViewTwo.frame = CGRectMake(0,bottomViewOne.sh_bottom,ScreenWidth,10);
    bottomViewTwo.backgroundColor = [UIColor lightGrayColor];
