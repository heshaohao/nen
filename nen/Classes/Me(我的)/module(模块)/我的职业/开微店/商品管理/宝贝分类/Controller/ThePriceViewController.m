...
@interface ThePriceViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ThePriceViewController
...
- (void)loadNewData
{
    ...
    NSDictionary *dict = @{@"page":@"1",@"pagesize":@"8",@"type":@"price",@"shop_id":self.shopId};
...
- (void)loadMoreData
{
    ...
    NSDictionary *dict = @{@"page":self.page,@"pagesize":@"8",@"type":@"new",@"shop_id":self.shopId};
