//
//  ClassificationManagementCell.m
//  nen
//
...
@interface ClassificationManagementCell ()
...
@implementation ClassificationManagementCell
...
-(void)addSubviewControll
{
    ...
    iconImag.frame = CGRectMake(10,10,100,125);
    ...
    centerTitle.frame = CGRectMake(iconImag.sh_right + 10,iconImag.sh_y,ScreenWidth - 130,35);
    ...
    soldItemTitle.frame = CGRectMake(discountPriceTitle.sh_x,discountPriceTitle.sh_bottom + 20,80,20);
