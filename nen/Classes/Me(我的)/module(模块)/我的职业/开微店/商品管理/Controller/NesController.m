...
@interface NesController ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)loadNewData
{
    ...
    NSDictionary *dict = @{@"page":@"1",@"pagesize":@"8",@"type":@"new",@"shop_id":self.shopId};
