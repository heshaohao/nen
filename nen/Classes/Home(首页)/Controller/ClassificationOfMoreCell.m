...
@interface ClassificationOfMoreCell ()
// 商品图片
...
@implementation ClassificationOfMoreCell
...
- (void)addsubViewControll
{
    ...
    mainBodyView.frame = CGRectMake(0,0,ScreenWidth,145);
    ...
    originalPriceTitle.frame = CGRectMake(discountPriceTitle.sh_right + 10 ,commentTitle.sh_bottom,120,20);
    ...
    cityTitle.frame = CGRectMake(freightTitle.sh_right,freightTitle.sh_bottom - (freightTitle.sh_height *0.5),50,20);
    cityTitle.text = @"城市";
...
- (void)buyBtn
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"pushBuyVc" object:self userInfo:dict];
}
...
-(void)shareBtnClick:(UIButton *)btn
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"shareBtn" object:self userInfo:dict];
