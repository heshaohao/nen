//
//  UIButton+CenterTitleAndImage.m
//  nen
//
...
@implementation UIButton (CenterTitleAndImage)
...
- (void)verticalCenterImageAndTitle:(CGFloat)spacing
{
    ...
    self.imageEdgeInsets = UIEdgeInsetsMake(- (titleSize.height + spacing/2) ,3, 0.0, - titleSize.width);
