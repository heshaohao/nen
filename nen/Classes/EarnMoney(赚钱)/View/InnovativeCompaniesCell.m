...
#import "InnovativeCompaniesCell.h"
#import "ForumPostModel.h"
#import "PostBtn.h"

@interface InnovativeCompaniesCell()
...
@implementation InnovativeCompaniesCell
...
- (void)commentBtnClick
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"innovativeCommentBtn" object:self userInfo:dict];
    ...
    if (!self.thumbUpBtns.selected)
    {
        ...
        [manager POST:splitCompleteStr parameters:dict success:^(NSURLSessionDataTask *task, id responseObject) {
           ...
           // NSLog(@"%@",responseObject);
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:@"innovativeThumbBtn" object:self];
