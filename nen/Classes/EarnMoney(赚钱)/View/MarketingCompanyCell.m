...
@interface MarketingCompanyCell()
...
@implementation MarketingCompanyCell
...
- (void)commentBtnClick
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"marketingCommentBtn" object:self userInfo:dict];
    ...
    if (!self.thumbUpBtns.selected)
    {
        ...
        [manager POST:splitCompleteStr parameters:dict success:^(NSURLSessionDataTask *task, id responseObject) {
          ...
          //  NSLog(@"%ld",(long)thumbCount);
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:@"marketingThumbBtn" object:self];
